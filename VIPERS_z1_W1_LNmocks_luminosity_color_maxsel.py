...
# When we use ONLY N-body sims, and there is no selection function, then compute
# window functions of all tracers as mean of window functions of each tracer
#is_n_body_sims = True
is_n_body_sims = False
########################################
...
mass_fun_file = "mf_Vipers_W1_LNmocks.dat"
halo_bias_file = "bias_Vipers_W1_LNmocks.dat"
hod_file = "hod_Vipers_W1_LNmocks.dat"

#mass_fun_file = "mf_tinker_iterate.dat"
#halo_bias_file = "bias_tinker_iterate.dat"
#hod_file = "hod_iterate.dat"

# Number of halo bins
nhalos = 4
halos_ids = ['G1', 'G2', 'G3','G4']
#halos_ids = ['H0','H1','H2','H3','H4','H5','H6','H7','H8','H9','H10','H11','H12','H13']
# Number of galaxy types
ngals = 4
gal_ids = ['blue-faint', 'red-faint', 'blue-bright','red-bright']
...
sel_fun_file = "selfunc_73_16_70.hdf5"
...
cell_low_count_thresh = 0.000001
...
mult_sel_fun, shift_sel_fun = 100.0 , 0.000000001
...
#nbarorig = [0.85, 0.293, 0.0922,0.024755]
#ncentral = [10.,10.0,10.0,10.0]
#nsigma   = [20000.0,20000.0,20000.0,20000.0]
################################
...
#mocks_bias = [1.0,2.0,1.3,1.75]
mocks_bias = [0.7,1.3,0.9,1.2]
...
vdisp = [0.0008,0.0004,0.0008,0.0004]
################################
