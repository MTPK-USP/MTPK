...
mass_fun_file = "ExSHalos_MF.dat"
halo_bias_file = "ExSHalos_bias.dat"
...
ntracers = nhalos
tracer_ids = halos_ids
bias_file = halo_bias_file
...
natali = np.loadtxt('inputs/ExSHalos_MF.dat')
nbar = list(natali) #[0.001694836] #MF*CELL^3
ncentral = ntracers*[ 20.0 ]
...
#shot_fudge = nhalos*[0.5]
shot_fudge = nhalos*[0.0]
shot_fudge_FKP=nhalos*[0.0]
shot_fudge_MT=nhalos*[0.0]
